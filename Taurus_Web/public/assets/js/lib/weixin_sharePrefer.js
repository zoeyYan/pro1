...
//	    			  key=res.id.accountId;
//	    			}
//		    	});
//				share.link=link_pack.APP_link+"prefer.html?acountId="+ key;		    	
				var val=$('.proceeds').html();
				share.title="《第一财经》股市天天向上,我今天的累积收益为："+val+"%";
        }
